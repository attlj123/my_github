...
#define FLASH_END_ADDR       (uint32_t)(0x0817FFFF)
...
#define FLASH_BANK1_USER_END_ADDR           (ADDR_FLASH_SECTOR_4_BANK1 - 1)  /* End @ of user Flash area Bank1 */

#define FLASH_BANK2_USER_START_ADDR         ADDR_FLASH_SECTOR_0_BANK2        /* Start @ of user Flash area Bank1 */
#define FLASH_BANK2_USER_END_ADDR           (ADDR_FLASH_SECTOR_4_BANK2 - 1)  /* End @ of user Flash area Bank1 */
